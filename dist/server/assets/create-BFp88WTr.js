import { Y as requireReact, U as reactExports, y as getDefaultExportFromCjs, a as React, L as jsxRuntimeExports } from "./server-CNVNdsAu.js";
import { o as createLucideIcon, k as clsx, y as reactDomExports, E as EventEmitter, l as cn, H as useNavigate, I as useWallet, G as truncateAddress, A as AnimatePresence, x as motion, g as Plus, h as PublicKey, F as toast, m as connection } from "./router-B3y7OxSE.js";
import { a as useCreateVault, W as Wallet } from "./useTherProgram-HHTMB16I.js";
import { m as usePlatformConfig, b as getMint } from "./useVaults-DNOt5NPY.js";
import { a as CircleX, b as Clock, C as CircleCheck } from "./clock-YOZa94Gt.js";
import { A as AtSign, G as Globe, S as Send } from "./send-DvLw6O4a.js";
...
var _excluded$c = ["children", "width", "height", "viewBox", "className", "style", "title", "desc"];
function _extends$e() {
...
var Surface = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  var {
    ...
    title,
    desc
  } = props, others = _objectWithoutProperties$c(props, _excluded$c);
  var svgView = viewBox || {
    width,
    height,
    x: 0,
  ...
  return /* @__PURE__ */ reactExports.createElement("svg", _extends$e({}, svgPropertiesAndEvents(others), {
...
var Layer = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("g", _extends$d({
    className: layerClass
...
var _excluded$a = ["type", "size", "sizeType"];
function _extends$c() {
...
var Symbols = (_ref2) => {
  var {
    ...
    size = 64,
    sizeType = "area"
  } = _ref2, rest = _objectWithoutProperties$a(_ref2, _excluded$a);
  var props = _objectSpread$r(_objectSpread$r({}, rest), {}, {
    type,
    size,
    sizeType
  });
  ...
  if (isNumber(cx) && isNumber(cy) && isNumber(size)) {
    return /* @__PURE__ */ reactExports.createElement("path", _extends$c({}, filteredProps, {
...
var appendOffsetOfLegend = (offset, legendSettings, legendSize) => {
  if (legendSettings && legendSize) {
    ...
    if ((layout === "vertical" || layout === "horizontal" && verticalAlign === "middle") && align !== "center" && isNumber(offset[align])) {
      return _objectSpread$p(_objectSpread$p({}, offset), {}, {
...
function getTooltipEntry(_ref4) {
  ...
  return _objectSpread$p(_objectSpread$p({}, tooltipEntrySettings), {}, {
    dataKey,
    payload,
    value,
    name
...
var selectChartOffsetInternal = createSelector([selectChartWidth, selectChartHeight, selectMargin, selectBrushHeight, selectLeftAxesOffset, selectRightAxesOffset, selectTopAxesOffset, selectBottomAxesOffset, selectLegendSettings, selectLegendSize], (chartWidth, chartHeight, margin, brushHeight, leftAxesOffset, rightAxesOffset, topAxesOffset, bottomAxesOffset, legendSettings, legendSize) => {
  ...
  var offset = _objectSpread$o(_objectSpread$o({}, offsetV), offsetH);
...
var ResponsiveContainer = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ reactExports.createElement(SizeDetectorContainer, _extends$b({}, props, {
    width,
    height,
    ref
  }));
...
var mapObject = (fn, obj) => Object.keys(obj).reduce((res, key) => _objectSpread$l(_objectSpread$l({}, res), {}, {
  [key]: fn(key, obj[key])
}), {});
...
function createStepperUpdate(from2, to2, easing, interKeys, render, timeoutController) {
  var preTime;
  var stepperStyle = interKeys.reduce((res, key) => _objectSpread$k(_objectSpread$k({}, res), {}, {
    [key]: {
      from: from2[key],
      velocity: 0,
      to: to2[key]
  ...
  var stepperUpdate = (now) => {
    ...
    render(_objectSpread$k(_objectSpread$k(_objectSpread$k({}, from2), to2), getCurrStyle()));
    preTime = now;
...
function createTimingUpdate(from2, to2, easing, duration, interKeys, render, timeoutController) {
  ...
  var timingStyle = interKeys.reduce((res, key) => {
    ...
    return _objectSpread$k(_objectSpread$k({}, res), {}, {
  ...
  var timingUpdate = (now) => {
    ...
    render(_objectSpread$k(_objectSpread$k(_objectSpread$k({}, from2), to2), currStyle));
    if (t < 1) {
      stopAnimation = timeoutController.setTimeout(timingUpdate);
    } else {
      var finalStyle = mapObject((key, val) => alpha(...val, easing(1)), timingStyle);
      render(_objectSpread$k(_objectSpread$k(_objectSpread$k({}, from2), to2), finalStyle));
    }
  };
  return () => {
    stopAnimation = timeoutController.setTimeout(timingUpdate);
...
const configUpdate = (from2, to2, easing, duration, render, timeoutController) => {
  ...
  if (easing == null) {
    return () => {
      render(_objectSpread$k(_objectSpread$k({}, from2), to2));
      return () => {
      };
    };
  }
...
var _excluded$9 = ["radius"], _excluded2$4 = ["radius"];
...
var Rectangle = (rectangleProps) => {
  ...
  if (!isUpdateAnimationActive) {
    var _svgPropertiesAndEven = svgPropertiesAndEvents(props), {
      radius: _
    } = _svgPropertiesAndEven, otherPathProps = _objectWithoutProperties$9(_svgPropertiesAndEven, _excluded$9);
    return /* @__PURE__ */ reactExports.createElement("path", _extends$9({}, otherPathProps, {
      x: round$1(x2),
      y: round$1(y2),
      width: round$1(width),
  ...
  return /* @__PURE__ */ reactExports.createElement(JavascriptAnimate, {
    ...
    var _svgPropertiesAndEven2 = svgPropertiesAndEvents(props), {
      radius: _2
    } = _svgPropertiesAndEven2, otherPathProps2 = _objectWithoutProperties$9(_svgPropertiesAndEven2, _excluded2$4);
    return /* @__PURE__ */ reactExports.createElement("path", _extends$9({}, otherPathProps2, {
      radius: typeof radius === "number" ? radius : void 0,
      className: layerClass,
      d: getRectanglePath(currX, currY, currWidth, currHeight, radius),
      ref: pathRef,
      style: _objectSpread$j(_objectSpread$j({}, animationStyle), props.style)
    }));
  });
};
...
var inRangeOfSector = (_ref5, viewBox) => {
  ...
  if (inRange) {
    return _objectSpread$i(_objectSpread$i({}, viewBox), {}, {
      radius,
...
var Sector = (sectorProps) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("path", _extends$8({}, svgPropertiesAndEvents(props), {
    className: layerClass,
    d: path
  }));
};
...
var selectAngleAxis = createSelector([selectAngleAxisNoDefaults, selectPolarChartLayout], (angleAxisSettings, layout) => {
  ...
  return _objectSpread$h(_objectSpread$h({}, implicitAngleAxis), {}, {
    type: evaluatedType
  });
});
...
var selectRadiusAxis = createSelector([selectRadiusAxisNoDefaults, selectPolarChartLayout], (radiusAxisSettings, layout) => {
  ...
  return _objectSpread$h(_objectSpread$h({}, implicitRadiusAxis), {}, {
    type: evaluatedType
  });
});
...
createSelector(selectBaseAxis, selectAxisScale, (axis, scale) => {
  ...
  return _objectSpread$g(_objectSpread$g({}, axis), {}, {
    scale
  });
});
...
var combineTooltipInteractionState = (tooltipState, tooltipEventType, trigger, defaultIndex) => {
  ...
  if (hasBeenActivePreviously(appropriateMouseInteraction)) {
    if (activeFromProps) {
      return _objectSpread$f(_objectSpread$f({}, appropriateMouseInteraction), {}, {
        active: true
      });
    }
  ...
  return _objectSpread$f(_objectSpread$f({}, noInteraction), {}, {
  ...
  return tooltipPayloadConfigurations.reduce((agg, _ref2) => {
    ...
    if (Array.isArray(tooltipPayload)) {
      tooltipPayload.forEach((item) => {
        ...
        var newSettings = _objectSpread$e(_objectSpread$e({}, settings), {}, {
          name: itemName,
...
var getActivePolarCoordinate = (layout, tooltipTicks, activeIndex, rangeObj) => {
  ...
  if (entry) {
    if (layout === "centric") {
      ...
      return _objectSpread$d(_objectSpread$d(_objectSpread$d({}, rangeObj), polarToCartesian(rangeObj.cx, rangeObj.cy, _radius, _angle)), {}, {
        angle: _angle,
        radius: _radius
      });
    }
    ...
    return _objectSpread$d(_objectSpread$d(_objectSpread$d({}, rangeObj), polarToCartesian(rangeObj.cx, rangeObj.cy, radius, angle)), {}, {
      angle,
      radius
    });
  }
...
var seed = {};
var initialState$a = {
  zIndexMap: Object.values(DefaultZIndexes).reduce((acc, current2) => _objectSpread$c(_objectSpread$c({}, acc), {}, {
    [current2]: {
      element: void 0,
      ...
      if (syncMethod === "index") {
        ...
        if (viewBox && action !== null && action !== void 0 && (_action$payload = action.payload) !== null && _action$payload !== void 0 && _action$payload.coordinate && action.payload.sourceViewBox) {
          var _action$payload$coord = action.payload.coordinate, {
            x: _x,
            y: _y
          } = _action$payload$coord, otherCoordinateProps = _objectWithoutProperties$8(_action$payload$coord, _excluded$8);
          var {
            x: sourceX,
            y: sourceY,
            width: sourceWidth,
...
var _excluded$7 = ["x", "y", "lineHeight", "capHeight", "fill", "scaleToFit", "textAnchor", "verticalAnchor"], _excluded2$3 = ["dx", "dy", "angle", "className", "breakAll"];
function _extends$7() {
...
var Text = /* @__PURE__ */ reactExports.forwardRef((outsideProps, ref) => {
  var _resolveDefaultProps = resolveDefaultProps(outsideProps, textDefaultProps), {
    ...
    textAnchor,
    verticalAnchor
  } = _resolveDefaultProps, props = _objectWithoutProperties$7(_resolveDefaultProps, _excluded$7);
  ...
  var {
    ...
    className,
    breakAll
  } = props, textProps = _objectWithoutProperties$7(props, _excluded2$3);
...
var _excluded$6 = ["labelRef"], _excluded2$2 = ["content"];
...
function Label(outerProps) {
  ...
  if (/* @__PURE__ */ reactExports.isValidElement(content)) {
    var {
      labelRef: _
    } = propsWithViewBox, propsWithoutLabelRef = _objectWithoutProperties$6(propsWithViewBox, _excluded$6);
    return /* @__PURE__ */ reactExports.cloneElement(content, propsWithoutLabelRef);
  }
  if (typeof content === "function") {
    var {
      content: _2
    } = propsWithViewBox, propsForContent = _objectWithoutProperties$6(propsWithViewBox, _excluded2$2);
  ...
  return /* @__PURE__ */ reactExports.createElement(ZIndexLayer, {
    zIndex: props.zIndex
  }, /* @__PURE__ */ reactExports.createElement(Text, _extends$6({
    ref: labelRef,
...
var _excluded$5 = ["valueAccessor"], _excluded2$1 = ["dataKey", "clockWise", "id", "textBreakAll", "zIndex"];
function _extends$5() {
...
function LabelList(_ref2) {
  ...
  } = _ref2, restProps = _objectWithoutProperties$5(_ref2, _excluded$5);
  var {
    dataKey,
    clockWise,
    id,
    textBreakAll,
    zIndex
  } = restProps, others = _objectWithoutProperties$5(restProps, _excluded2$1);
...
var selectDisplayedData = createSelector([selectChartDataAndAlwaysIgnoreIndexes, selectSynchronisedPieSettings, pickCells], (_ref2, pieSettings, cells) => {
  ...
  if ((!displayedData || !displayedData.length) && cells != null) {
    displayedData = cells.map((cell) => _objectSpread$7(_objectSpread$7({}, pieSettings.presentationProps), cell.props));
  }
...
var Trapezoid = (outsideProps) => {
  ...
  return /* @__PURE__ */ reactExports.createElement(JavascriptAnimate, {
    ...
    return /* @__PURE__ */ reactExports.createElement("path", _extends$4({}, svgPropertiesAndEvents(trapezoidProps), {
      ...
      ref: pathRef,
      style: _objectSpread$6(_objectSpread$6({}, animationStyle), trapezoidProps.style)
    }));
  });
};
...
function defaultPropTransformer(option, props) {
  return _objectSpread$5(_objectSpread$5({}, props), option);
}
...
function Shape(_ref2) {
  ...
  var shape;
  if (/* @__PURE__ */ reactExports.isValidElement(option)) {
    shape = /* @__PURE__ */ reactExports.cloneElement(option, _objectSpread$5(_objectSpread$5({}, props), getPropsFromShapeOption(option)));
...
var _excluded$3 = ["key"], _excluded2 = ["onMouseEnter", "onClick", "onMouseLeave"], _excluded3 = ["id"], _excluded4 = ["id"];
function _extends$3() {
...
var SetPieTooltipEntrySettings = /* @__PURE__ */ reactExports.memo((_ref2) => {
  ...
  var tooltipDataDefinedOnItem = sectors.map((sector) => {
    ...
    return sectorTooltipPayload.map((item) => _objectSpread$4(_objectSpread$4({}, item), {}, {
...
var renderLabelLineItem = (option, props) => {
  ...
  var {
    key
  } = props, otherProps = _objectWithoutProperties$3(props, _excluded$3);
...
function PieSectors(props) {
  ...
  } = allOtherPieProps, restOfAllOtherProps = _objectWithoutProperties$3(allOtherPieProps, _excluded2);
  ...
  return /* @__PURE__ */ reactExports.createElement(PieLabelListProvider, {
    ...
    sectors === null || sectors === void 0 || sectors.forEach((entry, index) => {
      ...
      if (prev) {
        ...
        var latest2 = _objectSpread$4(_objectSpread$4({}, entry), {}, {
...
function PieImpl(props) {
  var {
    id
  } = props, propsWithoutId = _objectWithoutProperties$3(props, _excluded3);
  var {
    hide,
    className,
    rootTabIndex
...
function PieFn(outsideProps) {
  ...
  var {
    id: externalId
  } = props, propsWithoutId = _objectWithoutProperties$3(props, _excluded4);
  ...
  reducers: {
    ...
    updateYAxisWidth(state, action) {
      ...
      if (axis) {
        ...
        state.yAxis[id] = _objectSpread$3(_objectSpread$3({}, axis), {}, {
          width,
...
const STEPS = ["Identity", "Tokens", "Lock", "Revenue"];
function StepIndicator({ current: current2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between mb-10", children: STEPS.map((label, idx) => {
    const completed2 = idx < current2;
    const active = idx === current2;
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: cn(
              ...
              completed2 && "bg-[var(--green)] text-black",
              active && "bg-[var(--accent)] text-black shadow-[0_0_12px_var(--accent)]",
              !completed2 && !active && "bg-[var(--surface-2)] text-[var(--text-muted)]"
            ),
            children: completed2 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 14 }) : idx + 1
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono text-[var(--text-muted)] uppercase tracking-wide mt-2 whitespace-nowrap", children: label })
      ] }),
      idx < STEPS.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: cn(
            ...
            completed2 ? "bg-[var(--green)]" : "bg-[var(--text)]/10"
          )
        }
      )
    ] }, label);
...
function GlassToggle({ checked, onChange, className }) {
...
function CreatePage() {
  ...
  const [twitter, setTwitter] = reactExports.useState("");
  ...
  const [lockType, setLockType] = reactExports.useState("timed");
  const [duration, setDuration] = reactExports.useState("30");
  const [confirmRenounce, setConfirmRenounce] = reactExports.useState(false);
  const [shares, setShares] = reactExports.useState([]);
  const [shareAddr, setShareAddr] = reactExports.useState("");
  const [sharePct, setSharePct] = reactExports.useState("");
  const totalAllocatedBps = shares.reduce((acc, s2) => acc + s2.bps, 0);
  const remainingBps = 1e4 - totalAllocatedBps;
  ...
  async function addToken() {
    ...
    try {
      ...
      const name2 = `Token ${tokens.length + 1} (${symbol})`;
      setTokens((t) => [...t, {
        mint: mintInput,
        symbol,
        name: name2,
  ...
  const pieData = [...shares.map((s2) => ({
    name: truncateAddress(s2.address, 3),
    value: s2.bps
  })), {
    name: "Creator",
    value: remainingBps
  }];
  const canNext = step === 0 && name && description || step === 1 && tokens.length >= 2 && tokens.every((t) => t.mint_revoked && t.freeze_revoked && t.deposit >= Math.floor(t.supply * 0.01)) || step === 2 && (lockType === "timed" ? Number(duration) > 0 : confirmRenounce) || step === 3 || step === 4;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "min-h-screen pb-40 max-w-lg mx-auto px-4 pt-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-display font-bold text-center mb-2", children: "Create a Vault" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs font-mono text-[var(--text-muted)] mb-8", children: "Group SPL tokens into one immutable cross-launchpad pool" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      ...
      step === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { size: 14 }), label: "Vault Name", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: name, onChange: (e) => setName(e.target.value), placeholder: "Meme Titans", className: "w-full bg-[var(--surface-2)] rounded-xl px-4 py-3 font-display outline-none focus:ring-2 focus:ring-[var(--accent)]/40" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { size: 14 }), label: "Description", children: /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { value: description, onChange: (e) => setDescription(e.target.value), rows: 4, placeholder: "What does this vault represent?", className: "w-full bg-[var(--surface-2)] rounded-xl px-4 py-3 font-display outline-none focus:ring-2 focus:ring-[var(--accent)]/40 resize-none" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { size: 14 }), label: "Cover Image", children: image ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full h-40 rounded-xl overflow-hidden group border border-[var(--text)]/10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: image, alt: "cover", className: "w-full h-full object-cover" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => {
            setImage("");
            setCoverFile(null);
          }, className: "absolute top-2 right-2 w-8 h-8 rounded-full bg-black/60 hover:bg-black/80 flex items-center justify-center text-white backdrop-blur-sm transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { size: 16 }) })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "border-2 border-dashed border-[var(--text)]/20 rounded-2xl p-8 flex flex-col items-center gap-2 cursor-pointer hover:border-[var(--accent)]/50 transition-colors bg-[var(--surface-2)]/30 w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { size: 28, className: "text-[var(--text-muted)] animate-pulse" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-[var(--text-muted)]", children: "Click to choose image file" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono text-[var(--text-muted)]/60", children: "Supports JPG, PNG, GIF (Max 5MB)" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(AtSign, { size: 14 }), label: "Twitter / X", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: twitter, onChange: (e) => setTwitter(e.target.value), placeholder: "memetitans", className: "w-full bg-[var(--surface-2)] rounded-xl px-4 py-3 font-mono text-sm outline-none" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { size: 14 }), label: "Website", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: website, onChange: (e) => setWebsite(e.target.value), placeholder: "https://...", className: "w-full bg-[var(--surface-2)] rounded-xl px-4 py-3 font-mono text-sm outline-none" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { size: 14 }), label: "Telegram", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: telegram, onChange: (e) => setTelegram(e.target.value), placeholder: "memetitans", className: "w-full bg-[var(--surface-2)] rounded-xl px-4 py-3 font-mono text-sm outline-none" }) })
      ] }),
      step === 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 14 }), label: "Add Token by Mint", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: mintInput, onChange: (e) => setMintInput(e.target.value), placeholder: "Token mint address", className: "flex-1 bg-[var(--surface-2)] rounded-xl px-4 py-3 font-mono text-sm outline-none" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", disabled: verifying, onClick: addToken, className: "px-4 py-3 rounded-xl bg-[var(--accent)] text-black font-bold font-display text-sm disabled:opacity-50", children: verifying ? "Adding..." : "Add" })
        ] }) }),
        tokens.map((t, idx) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[var(--surface)] backdrop-blur-2xl rounded-2xl p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-gradient-to-br from-[var(--accent)] to-[var(--accent-2)] flex items-center justify-center text-[10px] font-mono font-bold text-black", children: t.symbol.slice(0, 3) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-medium truncate", children: t.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-xs text-[var(--accent)]", children: t.symbol })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setTokens((tk) => tk.filter((_, i) => i !== idx)), className: "text-[var(--text-muted)] hover:text-[var(--red)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 14 }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SafetyRow, { label: "Mint Authority", ok: t.mint_revoked }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SafetyRow, { label: "Freeze Authority", ok: t.freeze_revoked }),
            !okBoth && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-2 text-xs font-mono text-[var(--red)]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { size: 12 }),
              "Token cannot be added — revoke this authority first"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-3 text-xs font-mono", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "number", disabled: !okBoth, value: t.deposit || "", onChange: (e) => setTokens((tk) => tk.map((x2, i) => i === idx ? {
              ...x2,
              deposit: Number(e.target.value)
            } : x2)), placeholder: "Deposit amount", className: `w-full mt-2 bg-[var(--surface-2)] rounded-xl px-4 py-3 font-mono text-lg outline-none border-2 transition-colors ${belowMin ? "border-[var(--red)]" : t.deposit >= minDeposit ? "border-[var(--green)]" : "border-transparent"}` }),
            belowMin && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 mt-1 text-[10px] font-mono text-[var(--red)]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { size: 10 }),
              " Below 5% minimum"
            ] })
          ] }, idx);
        }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: addToken, className: "w-full py-3 rounded-2xl border-2 border-dashed border-[var(--text)]/20 hover:border-[var(--accent)]/50 flex items-center justify-center gap-2 transition-colors font-display text-[var(--text-muted)] text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 14 }),
          " Add Another Token"
        ] }),
        tokens.length >= 2 && new Set(tokens.map((t) => t.deposit)).size > 1 && tokens.every((t) => t.deposit > 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 p-3 rounded-xl bg-[var(--accent-2)]/10 text-xs font-mono text-[var(--accent-2)]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { size: 12 }),
          "Token deposit quantities differ — swaps are 1:1 by quantity regardless"
        ] })
      ] }),
      step === 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => setLockType("timed"), className: `p-5 rounded-2xl text-left transition-all duration-300 bg-[var(--surface)] backdrop-blur-2xl border-2 ${lockType === "timed" ? "border-[var(--accent)] shadow-[0_0_20px_rgba(0,229,255,0.1)]" : "border-transparent"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 20, className: "text-[var(--accent)] mb-2" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold mb-1", children: "Timed Lock" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-[var(--text-muted)]", children: "Tokens withdrawable after expiry" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => setLockType("permanent"), className: `p-5 rounded-2xl text-left transition-all duration-300 bg-[var(--surface)] backdrop-blur-2xl border-2 ${lockType === "permanent" ? "border-[var(--red)] shadow-[0_0_20px_rgba(255,68,68,0.1)]" : "border-transparent"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { size: 20, className: "text-[var(--red)] mb-2" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold mb-1", children: "Permanent" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-[var(--red)]/70", children: "Locked forever — no withdrawals" })
          ] })
        ] }),
        lockType === "timed" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[var(--surface)] rounded-2xl p-4 backdrop-blur-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-[var(--text-muted)] mb-3 uppercase tracking-wider", children: "Lock duration" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: [{
            ...
            l: "1 Year",
            v: "365"
          }].map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setDuration(p.v), className: `px-3 py-1.5 rounded-full text-xs font-mono transition-colors ${duration === p.v ? "bg-[var(--accent)] text-black" : "bg-[var(--surface-2)] text-[var(--text-muted)] hover:text-[var(--text)]"}`, children: p.l }, p.v)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "number", value: duration, onChange: (e) => setDuration(e.target.value), className: "w-full mt-3 bg-[var(--surface-2)] rounded-xl px-4 py-3 font-mono outline-none", placeholder: "Days" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-3 text-xs font-mono text-[var(--text-muted)]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 12 }),
            "Unlocks",
            " ",
            new Date(Date.now() + Number(duration) * 864e5).toLocaleDateString()
          ] })
        ] }),
        lockType === "permanent" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-4 rounded-xl bg-[var(--red)]/5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(GlassToggle, { checked: confirmRenounce, onChange: setConfirmRenounce }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono", children: "I understand this is permanent and irreversible" })
        ] })
      ] }),
      step === 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4 rounded-xl bg-[var(--surface-2)]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Wallet, { size: 14, className: "text-[var(--text-muted)]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-sm truncate", children: publicKey ? truncateAddress(publicKey.toBase58()) : "Connect wallet" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono text-[var(--text-muted)]", children: "(creator)" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-sm font-bold text-[var(--accent)]", children: [
            (remainingBps / 100).toFixed(0),
            "%"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChartPie, { size: 28, className: "text-[var(--accent)] mx-auto" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-4xl font-display font-bold text-[var(--accent)] mt-1", children: [
            (remainingBps / 100).toFixed(0),
            "%"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-[var(--text-muted)]", children: "Remaining to allocate" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[200px]", style: {
          minWidth: 0,
          minHeight: 0
        }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", minWidth: 0, minHeight: 0, children: /* @__PURE__ */ jsxRuntimeExports.jsx(PieChart, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pie, { data: pieData, dataKey: "value", cx: "50%", cy: "50%", innerRadius: 50, outerRadius: 80, stroke: "none", children: pieData.map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: PIE_COLORS[i % PIE_COLORS.length] }, i)) }) }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: shareAddr, onChange: (e) => setShareAddr(e.target.value), placeholder: "Wallet address", className: "flex-1 bg-[var(--surface-2)] rounded-xl px-4 py-3 font-mono text-sm outline-none" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "number", value: sharePct, onChange: (e) => setSharePct(e.target.value), placeholder: "%", className: "w-20 bg-[var(--surface-2)] rounded-xl px-4 py-3 font-mono text-sm outline-none" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: addShare, disabled: remainingBps === 0, className: "px-4 rounded-xl bg-[var(--accent)] text-black disabled:opacity-40", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 16 }) })
        ] }),
        shares.map((s2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-3 rounded-xl bg-[var(--surface)]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs truncate", children: truncateAddress(s2.address) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-sm text-[var(--accent)]", children: [
              (s2.bps / 100).toFixed(0),
              "%"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setShares((sh) => sh.filter((_, idx) => idx !== i)), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 12, className: "text-[var(--red)]" }) })
          ] })
        ] }, i)),
        remainingBps < 1e3 && remainingBps > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 p-3 rounded-xl bg-[var(--accent-2)]/10 text-xs font-mono text-[var(--accent-2)]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { size: 12 }),
          "Only ",
          (remainingBps / 100).toFixed(0),
          "% remaining"
      ...
      step === 4 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { size: 36, className: "text-[var(--accent)] mx-auto" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-2xl text-center", children: "Review Your Vault" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[var(--surface)] rounded-2xl p-4 backdrop-blur-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] font-mono text-[var(--text-muted)] uppercase mb-2", children: "Identity" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold", children: name || "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-[var(--text-muted)] mt-1", children: description })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[var(--surface)] rounded-2xl p-4 backdrop-blur-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] font-mono text-[var(--text-muted)] uppercase mb-2", children: "Tokens" }),
          tokens.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between font-mono text-xs py-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t.symbol }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[var(--text-muted)]", children: t.deposit.toLocaleString() })
          ] }, t.mint))
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[var(--surface)] rounded-2xl p-4 backdrop-blur-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] font-mono text-[var(--text-muted)] uppercase mb-2", children: "Lock" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-sm", children: lockType === "permanent" ? "Permanent — Renounced" : `Timed — ${duration} days` })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[var(--surface-2)] rounded-2xl p-4 font-mono text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Vault Creation Fee" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              (platformConfig?.creationFee ?? 0.05).toFixed(3),
              " SOL"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Account Rent (est.)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "~0.011 SOL" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-[var(--text)]/10 mt-2 pt-2 flex justify-between font-bold", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Total" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              "~",
              ((platformConfig?.creationFee ?? 0.05) + 0.011).toFixed(3),
              " SOL"
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: submit, disabled: loading, className: "w-full py-4 rounded-2xl font-display font-bold text-black text-lg bg-[var(--accent)] shadow-[0_4px_24px_rgba(0,229,255,0.25)] hover:shadow-[0_8px_32px_rgba(0,229,255,0.35)] transition-all disabled:opacity-50", children: loading ? "Creating vault..." : "Create Vault" })
      ] })
    ] }, step) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between mt-8 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setStep((s2) => Math.max(0, s2 - 1)), disabled: step === 0, className: "flex-1 py-3 rounded-2xl bg-[var(--surface-2)] font-display font-bold text-sm disabled:opacity-40", children: "Back" }),
      step < 4 && /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => setStep((s2) => Math.min(4, s2 + 1)), disabled: !canNext, className: "flex-1 py-3 rounded-2xl bg-[var(--accent)] text-black font-display font-bold text-sm disabled:opacity-40 flex items-center justify-center gap-1", children: [
        "Continue ",
...
function Section({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[var(--surface)] backdrop-blur-2xl rounded-2xl p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs font-mono text-[var(--text-muted)] uppercase tracking-wider mb-3", children: [
      icon,
      label
    ] }),
    children
...
function SafetyRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-1.5 text-xs font-mono", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[var(--text-muted)]", children: label }),
    ok ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 text-[var(--green)]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { size: 12 }),
      " Revoked"
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 text-[var(--red)]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { size: 12 }),
      " Active"
    ] })
  ] });
